...
module.exports.security = {
  ...
  ***************************************************************************/
  ...
  cors: {
    allRoutes: true, // Cho phép CORS cho tất cả các route
    allowOrigins: [ 'http://localhost:5173'], // Các origin được phép truy cập
    allowCredentials: true, // Cho phép gửi cookie thông qua CORS
    allowRequestHeaders: 'content-type, authorization', // Các header được phép trong yêu cầu CORS
    allowRequestMethods: 'GET, POST, PATCH, DELETE, OPTIONS,' // Các phương thức HTTP được phép
  },
